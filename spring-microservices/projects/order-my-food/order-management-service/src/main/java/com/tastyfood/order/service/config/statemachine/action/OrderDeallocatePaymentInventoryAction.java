...
@Slf4j
public class OrderDeallocatePaymentInventoryAction implements Action<OrderState, OrderEvent> {
    ...
    public void execute(StateContext<OrderState, OrderEvent> context) {
        ...
        jmsTemplate.convertAndSend(JMSConfig.DEALLOCATE_PAYMENT_INVENTORY_QUEUE, restaurantOrder);
